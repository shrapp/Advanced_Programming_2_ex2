...
namespace MessagesApp.Controllers
{
    public class RatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Text,Name,Time")] Rate rate)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Text,Name,Time")] Rate rate)
        {
            if (id != rate.Id)
            {
                return NotFound();
